...
export const checkIfWorker = (account_id) => {
  var results = [];
  var is_worker = false;
  var worker_votes = 0;
...
export const checkIfWitness = (account_id) => {
  var results = [];
...
export const checkIfCommittee = (account_id) => {
  var results = [];
...
export const checkIfProxy = (account_id) => {
  var results = [];
  var is_proxy = false;
  var proxy_votes = 0;
...
export const getReferrers = (account_id, page) => {
  var results = [];
...
export const getReferrerCount = (account) => {
  var count = 0;
...
export const getFullAccount = (account) => {
  var full_account = {};
...
export const getTotalAccountOps = (account_id) => {
...
export const getAccountName = (account_id) => {
  var account_name = "";
...
export const parseAuth = (auth, type) => {
  var results = [];
...
export const parseBalance = (limit_orders, call_orders, balance, precision, symbol, callback) => {
...
export const parseVotes = (votes, callback) => {
  var results = [];
...
export const parseUIAs = (assets, callback) => {
  var results = [];
...
export const parseProposals = (proposals, callback) => {
  var results = [];
...
export const parseVesting = (vesting_balances, callback) => {
  var results = [];
...
export const getAccountHistory = (account_id, start, limit, callback) => {
