...
export const opText = (operation_type, operation) => {
  ...
  if (operation_type === 0) {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        // get me the to name:
        return axios.get(BASE_URL + "/account_name?account_id=" + to)
          .then(response_name_to => {
            var to_name = response_name_to.data;

            return axios.get(BASE_URL + "/asset?asset_id=" + amount_asset_id)
              .then(response_asset => {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        ...
        return axios.get(BASE_URL + "/asset?asset_id=" + amount_to_sell_asset_id)
          .then(response_asset1 => {
            ...
            return axios.get(BASE_URL + "/asset?asset_id=" +
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + funding_account)
      .then(response_name => {

        return axios.get(BASE_URL + "/asset?asset_id=" + delta_collateral_asset_id)
          .then(response_asset1 => {

            var asset1 = response_asset1.data.symbol;

            return axios.get(BASE_URL + "/asset?asset_id=" + delta_debt_asset_id)
              .then(response_asset2 => {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        ...
        return axios.get(BASE_URL + "/asset?asset_id=" + pays_asset_id)
          .then(response_asset1 => {
            ...
            return axios.get(BASE_URL + "/asset?asset_id=" + receives_asset_id)
              .then(response_asset2 => {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        ...
        if (registrar !== referrer) {
          ...
          return axios.get(BASE_URL + "/account_name?account_id=" + referrer)
            .then(response_name2 => {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        ...
        return axios.get(BASE_URL + "/account_name?account_id=" + account_to_list)
          .then(response_name2 => {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + issuer)
      .then(response_name => {

        return axios.get(BASE_URL + "/asset?asset_id=" + asset_to_issue_asset_id)
          .then(response_asset => {
            ...
            return axios.get(BASE_URL + "/account_name?account_id=" + issue_to_account)
              .then(response_name2 => {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        ...
        return axios.get(BASE_URL + "/asset?asset_id=" + amount_to_reserve_asset_id)
          .then(response_asset => {
    ...
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        ...
        return axios.get(BASE_URL + "/asset?asset_id=" + total_claimed_asset_id)
          .then(response_asset => {
  ...
  else if (operation_type === 54) { // PROPERTY CREATE
    return axios.get(BASE_URL + "/account_name?account_id=" + operation.issuer)
      .then(response_name => {
        operation_text = "<a href='/#/accounts/" + response_name + "'> " + " created property " + operation.property_id;
        return operation_text;
      });
  }
  else if (operation_type === 55) { // PROPERTY UPDATE
    return axios.get(BASE_URL + "/account_name?account_id=" + operation.issuer)
      .then(response_name => {
        operation_text = "<a href='/#/accounts/" + response_name + "'> " + " updated property " + operation.property_to_update;
        return operation_text;
      });
  }
  else if (operation_type === 56) { // PROPERTY APPROVE
    return axios.get(BASE_URL + "/account_name?account_id=" + operation.issuer)
      .then(response_name => {
        operation_text = "<a href='/#/accounts/" + response_name + "'> " + " approved property " + operation.property_to_approve;
        return operation_text;
      });
  }
  else if (operation_type === 57) { // PROPERTY DELETE
    return axios.get(BASE_URL + "/account_name?account_id=" + operation.fee_paying_account)
      .then(response_name => {
        operation_text = "<a href='/#/accounts/" + response_name + "'> " + " deleted property " + operation.property;
        return operation_text;
      });
  }
  else if (operation_type === 58) { // ASSET PRICE PUBLISH
    operation_account = operation.fee_paying_account;
    var symbol = operation.symbol;
    return axios.get(BASE_URL + "/account_name?account_id=" + operation_account)
      .then(response_name => {
        return axios.get(BASE_URL + "/asset?asset_id=" + symbol)
          .then(asset => {
            var asset_name = asset.data.symbol;
            var asset_precision = asset.data.precision;
            var divideby = Math.pow(10, asset_precision);
            var symbol_amount = Number(operation.usd_price.denominator / divideby);
            var usd_amount = Number(operation.usd_price.numerator / Math.pow(10, 6));

            operation_text = "<a href='/#/accounts/" + response_name + "'>" +
              response_name.data + "</a>  published price ";
            operation_text = operation_text + usd_amount / symbol_amount + " " + "USD" + "/" + "<a href='/#/assets/" + asset_name + "'>" +
              asset_name + "</a>" + " ";
            return operation_text;
          });
      });
