...
export const checkIfWitness = async (account_id) => {
    ...
    var witness_votes = 0;
    const response = await axios.get(BASE_URL + "/witnesses");
    for (var i = 0; i < response.data.length; i++) {
...
export const checkIfCommittee = async (account_id) => {
    ...
    const response = await axios.get(BASE_URL + "/committee_members");
    for (var i = 0; i < response.data.length; i++) {
...
export const getReferrers = async (account_id, page) => {
    var results = [];
    const response = await axios.get(BASE_URL + "/all_referrers?account_id=" + account_id + "&page=" + page);
...
export const getReferrerCount = async (account) => {
    var count = 0;
    const response = await axios.get(BASE_URL + "/referrer_count?account_id=" + account)
    count = response.data;
...
export const getFullAccount = async (account) => {
    var full_account = {};
    const response = await axios.get(BASE_URL + "/full_account?account_id=" + account)
...
export const getAccountName = async (account_id) => {
    var account_name = "";
    const response = await axios.get(BASE_URL + "/account_name?account_id=" + account_id);
...
export const parseAuth = async (auth, type) => {
    ...
    await auth.map(async value => {
        ...
        if (type === "key") {
            ...
            const response = await axios.get(BASE_URL + "/account_name?account_id=" + value[0]);
            authline = {
                account: value[0],
                threshold: value[1],
                account_name: response.data
...
export const getAssetNameAndPrecision = async (asset_id) => {
    var results = {};
    const response = await axios.get(BASE_URL + "/asset?asset_id=" + asset_id);
